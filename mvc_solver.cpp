...
mvc_solver::mvc_solver(int _p_c, int _ed_c, pii *_conns) : p_c(_p_c), ed_c(_ed_c), partial()
{
...
void mvc_solver::dsc_modify(int u, int v, int val)
{
    ...
    case 1: dsc[u] -= (val); break;
    case 2: dsc[v] -= (val); default : break;
    }
}
